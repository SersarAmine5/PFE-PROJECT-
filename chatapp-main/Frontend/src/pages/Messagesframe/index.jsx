  ...
  return (
    <>
      ...
      <div className="flex flex-col h-screen w-full ">
        ...
        <div className="flex flex-col flex-grow mx-auto w-[97%] md:w-full md:p-5" style={{ marginTop: '20px' }}>
          ...
          <div className="flex-grow overflow-y-auto w-full px-2" style={{ maxHeight: 'calc(100vh - 200px)', paddingBottom: '60px', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            <style>
            ...
            {messages.map((msg, index) => (
              <div key={index} className={`flex ${msg.outgoing ? 'justify-end' : 'justify-start'} my-2`}>
                <div className={`flex flex-col gap-y-1 max-w-[80%] p-3 rounded-lg shadow-md ${msg.outgoing ? 'bg-blue-500 mr-4' : 'bg-gray-400 ml-4'}`}>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white px-4 py-2 shadow-md">
          <div className="flex items-center gap-3">
            <Input
              ...
              prefix={
                <Img src="images/img_clock.svg" alt="clock" className="h-5 w-7 mr-2" />
              }
              value={newMessage}
              onChange={(e) => setNewMessage(e.target.value)}
              className="flex-grow rounded-md py-2 px-4 bg-gray-100 text-gray-900"
            />
            <Button className="bg-blue-500 rounded-lg p-2" onClick={handleSendMessage}>
